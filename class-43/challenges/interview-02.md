...
- Kerberos is an authentication system that can be activated in a domain environment on the domain controller. If a Windows system detects Kerberos is available, it will use it instead of NTLM.
